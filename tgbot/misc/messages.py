...
2. Не смотря на то, что переводы сделаны отдельным файлом, в интерфейсе программ не будет отдельного селекта с RU языком. Все, потому что разработчики технически ограничили эту возможность;
3. В интерфейсе программ будут встречаться непереведенные фрагменты текста. Это не потому, что перевод не полный, а потому что разработчики технически ограничили эту возможность;
